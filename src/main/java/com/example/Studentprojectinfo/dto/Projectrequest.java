...
public class Projectrequest {
   ...
   @Pattern(regexp = "^(Accepted|Rejected|Pending)$") // Accepted, Rejected, Pending
    ...
    @NotNull(message = "Hod name cannot be null") @Pattern(regexp = "^[a-zA-Z ]+$") // Only letters and spaces allowed for hod name.
    ...
    public String topic;
    @NotNull(message = "Github link cannot be null")@Pattern(regexp = "^(https?://)?(www.)?github.com/[a-zA-Z0-9-]+/[a-zA-Z0-9-]+$") // Github link validation.
